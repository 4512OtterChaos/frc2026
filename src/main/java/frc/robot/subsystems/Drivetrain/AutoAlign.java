...
public class AutoAlign extends Command {
    ...
    public void execute() {
        ...
        double finalAlignXOffset = 0;//config.alignBackwards ? finalDist : -finalDist;//TODO
        ...
        double finalAlignXSpeed = finalAlignSpeed;//config.alignBackwards ? -finalAlignSpeed : finalAlignSpeed;//TODO

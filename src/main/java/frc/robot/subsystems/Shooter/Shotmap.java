...
public class Shotmap {
    ...
    static {
        // 4.86 
        addState(Meters.of(2.26), Degrees.of(21), RPM.of(2550), Seconds.of(1.12));
        addState(Meters.of(3.5), Degrees.of(24), RPM.of(2950), Seconds.of(1.32));
        addState(Meters.of(5.57), Degrees.of(34), RPM.of(3425), Seconds.of(1.41));
        addState(Meters.of(14.00), Degrees.of(45), RPM.of(4500), Seconds.of(1.6));//TODO: not real tof
    }

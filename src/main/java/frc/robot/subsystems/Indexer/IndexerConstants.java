...
public class IndexerConstants {
    ...
    public static final TunableNumber spindexerkP = new TunableNumber("Indexer/Spindexer/PID/P",
            kSpindexerConfig.Slot0.kP);
    public static final TunableNumber spindexerkI = new TunableNumber("Indexer/Spindexer/PID/I",
            kSpindexerConfig.Slot0.kI);
    public static final TunableNumber spindexerkD = new TunableNumber("Indexer/Spindexer/PID/D",
            kSpindexerConfig.Slot0.kD);

    public static final TunableNumber spindexerkS = new TunableNumber("Indexer/Spindexer/Feed Forward/S",
            kSpindexerConfig.Slot0.kS);
    public static final TunableNumber spindexerkV = new TunableNumber("Indexer/Spindexer/Feed Forward/V",
            kSpindexerConfig.Slot0.kV);
    public static final TunableNumber spindexerkA = new TunableNumber("Indexer/Spindexer/Feed Forward/A",
            kSpindexerConfig.Slot0.kA);
    ...
    public static final TunableNumber feederkS = new TunableNumber("Indexer/Feeder/Feed Forward/S",
            kFeederConfig.Slot0.kS);
    public static final TunableNumber feederkV = new TunableNumber("Indexer/Feeder/Feed Forward/V",
            kFeederConfig.Slot0.kV);
    public static final TunableNumber feederkA = new TunableNumber("Indexer/Feeder/Feed Forward/A",
